...
#if defined(NDEBUG)
# error "Oxcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x76eb482d69728edc6e81c62eef606b74b7d740f263ddf8724c155065bddd6065");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Oxcoin: starting difficulty is 1 / 2^12
...
{
    // Oxcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Oxcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Oxcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1496865010, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "1496787159";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 30 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("046fc7afe07821c8cee40d59a6b57b9c364034d64f2a3caed6775a1eb0d50662f92d828d217a28891b026703e8ada8491a0075c49740ff9a7d599edc66bfda2800") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1496865010;
        ...
        assert(block.hashMerkleRoot == uint256("0x2c57e8b3d3283f49f15c2832d80af1b32a2a46de98f047d89e81243ccb6eaf97"));
...
unsigned char pchMessageStart[4] = { 0x67, 0x42, 0x05, 0x51 }; // Oxcoin: increase each by adding 2 to bitcoin's value.
...
void static OxcoinMiner(CWallet *pwallet)
{
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&OxcoinMiner, pwallet));
}
